      ...
      <div className="m-3 p-6 bg-white rounded-xl shadow-md">
        ...
        <div className="flex gap-3">
          ...
          <label className="mt-4 px-4 py-4 flex items-center gap-3 cursor-pointer hover:bg-gray-50 rounded-lg">
            <input type="radio" name="completed" value='true' checked={taskStatus === true} onChange={(e)=>setTaskStatus(e.target.value === 'true')} className="h-4 w-4 accent-blue-600 cursor-pointer" />
            <span className="text-sm font-medium text-gray-700">Completed</span>
          </label>
          <label className="ms-2 mt-4 px-4 flex items-center gap-3 cursor-pointer hover:bg-gray-50 rounded-lg">
            <input type="radio" name="completed" value='false' checked={taskStatus === false} onChange={(e)=>setTaskStatus(e.target.value === 'true')} className="h-4 w-4 accent-blue-600 cursor-pointer" />
